/**
 * Type definitions for Redux Form v6 RC 3
 *
 * How the interfaces stack up upon rendering:
 *  <Form>
 *    <MyForm props=FormProps>
 *      <Field props=BaseFieldProps & MyFieldProps>
 *        <MyTextField props=WrappedFieldProps>
 */
...
declare namespace ReduxForm {
   ...
   */
  export interface WrappedFieldProps<MyFieldProps> {
    /**
   ...
   * Any others will be passed through to your component.
   */
  export interface BaseFieldArrayProps {
    /**
     * A string path, in dot-and-bracket notation, corresponding to a value
     * in the form values. It may be as simple as 'firstName' or as complicated
     * as contact.billing.address[2].phones[1].areaCode.
   ...
   */
  export interface WrappedFieldArrayProps<T> {
