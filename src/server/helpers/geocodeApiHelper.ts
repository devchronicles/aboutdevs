import * as geocodeTypes from "../typings/googlePlacesSearchTypes";
//
...
// export const CITY_COMPONENT_TYPE = "locality";
...
export function getLongitudeLatitude(geometry: geocodeTypes.Geometry): { longitude: number, latitude: number } {
    return {longitude: geometry.location.lng, latitude: geometry.location.lat};
}
