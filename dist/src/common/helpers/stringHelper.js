...
function removeDiacritics(str) {
    if (str === null || str === undefined)
        throw Error("Argument 'str' should be null or undefined");
 ...
 * @param {string} str The input string
 */
function replaceNonAlphaNumericCharactersWith(str, replacement = " ") {
    if (str === null || str === undefined)
        throw Error("Argument 'str' should be null or undefined");
    return str.replace(/[^a-z0-9]+/gi, replacement);
}
exports.replaceNonAlphaNumericCharactersWith = replaceNonAlphaNumericCharactersWith;
/**
 ...
 * @param {string} str The input string
 */
function removeDuplicateDashes(str) {
    if (str === null || str === undefined)
        throw Error("Argument 'str' should be null or undefined");
    return str.replace(/-+/g, "-");
}
exports.removeDuplicateDashes = removeDuplicateDashes;
/**
 ...
 */
function incrementLast(str, addIfNoNumber = false) {
    if (str === null || str === undefined)
        throw Error("Argument 'str' should be null or undefined");
    const regex = /[0-9]+$/;
    if (str.match(regex)) {
...
exports.incrementLast = incrementLast;
/**
 ...
 * @returns {any}
 */
function normalizeForSearch(text, noAlphaNumerics = true, noDiacritics = true, noDuplicateSpaces = true, noUpperCase = true) {
    if (!text) {
        return "";
    }
...
exports.normalizeForUrl = normalizeForUrl;
